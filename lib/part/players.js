...
Players.prototype.edit = function (player_id, params, callback) {
    ...
    this.request('PUT', ['players', player_id], params, callback, function (res, result) { 
        callback(null, result); 
    });
}; // edit
...
Players.prototype.on_session = function (player_id, params, callback) {
    ...
    this.request('POST', ['players', player_id, 'on_session'], params, callback, function (res, result) { 
        callback(null, result); 
    });
}; // on_session
...
Players.prototype.on_purchase = function (player_id, params, callback) {
    ...
    this.request('POST', ['players', player_id, 'on_purchase'], params, callback, function (res, result) {
        callback(null, result);
    });
}; // on_purchase
...
Players.prototype.on_focus = function (player_id, params, callback) {
    ...
    this.request('POST', ['players', player_id, 'on_focus'], params, callback, function (res, result) {
        callback(null, result);
    });
}; // on_purchase