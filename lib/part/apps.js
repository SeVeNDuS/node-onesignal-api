...
Apps.prototype.viewall = function (callback) {
    this.request('GET', ['apps'], undefined, {}, callback, function (res, result) { callback(null, result); });
...
Apps.prototype.view = function (app_id, callback) {
    ...
    this.request('GET', ['apps', app_id], undefined, {}, callback, function (res, result) { callback(null, result); });
...
Apps.prototype.create = function (apns_env, apns_p12, apns_p12_password, gcm_key, chrome_key, safari_apns_p12, safari_apns_p12_password, site_name, safari_site_origin, callback) {
    this.request('POST', ['apps'], undefined, { 
        apns_env : apns_env,
        apns_p12 : apns_p12, 
...
Apps.prototype.edit = function (app_id, name, apns_p12, apns_env, gcm_key, callback) {
    ...
    this.request('PUT', ['apps', app_id], undefined, { 
        name : name,
        apns_p12 : apns_p12, 
        apns_env : apns_env,
        gcm_key: gcm_key
